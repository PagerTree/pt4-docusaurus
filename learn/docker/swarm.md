...
It allows users to create and manage a cluster of [Docker](overview.md) hosts, known as a Swarm, and deploy applications across the [cluster](swarm.md#cluster) seamlessly.

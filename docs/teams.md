...
PagerTree offers the ability to export on-call calendars via iCalendar (.ics) format via a URL. This allows you to see who is on-call via your [Google Calendar](teams.md#google-calendar), [Outlook Calendar](teams.md#outlook-calendar), or [iCal (Mac) Calendar](#ical-mac-calendar).
...
### Special Notes Regarding 3rd Parties Importing Calendars
